...
public class SecurityConfig {
	...
	public SecurityFilterChain jwtOnlyFilterChain(HttpSecurity http) throws Exception {
		http
			...
			.securityMatcher(
				request -> request.getMethod().equals("POST") && request.getRequestURI().equals("/v1/clubs") || request.getRequestURI().startsWith("/v1/members") || request.getRequestURI().equals("/v1/clubs/me") || request.getRequestURI().equals("/v1/clubs/search")
