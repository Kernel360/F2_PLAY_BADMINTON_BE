...
public class MemberAlreadyExistInClubException extends BadmintonException {
    ...
    public MemberAlreadyExistInClubException(String memberToken, Long clubId, ClubMember.ClubMemberRole clubMemberRole) {
        super(ErrorCode.MEMBER_ALREADY_JOINED_CLUB,
                "[회원 아이디 : " + memberToken + " 동호회 아이디 : " + clubId + " 동호회 역할 : "
